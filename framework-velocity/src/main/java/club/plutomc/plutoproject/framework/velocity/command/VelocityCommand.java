...
import club.plutomc.plutoproject.framework.velocity.command.argument.ArgumentVelocityDouble;
import club.plutomc.plutoproject.framework.velocity.command.argument.ArgumentVelocityFloat;
import club.plutomc.plutoproject.framework.velocity.command.argument.ArgumentVelocityInteger;
import club.plutomc.plutoproject.framework.velocity.command.argument.ArgumentVelocityLong;
import club.plutomc.plutoproject.framework.velocity.command.executor.VelocityPlayerExecutor;
import club.plutomc.plutoproject.framework.velocity.command.sender.VelocityCommandSender;
import club.plutomc.plutoproject.framework.velocity.command.sender.VelocityConsoleCommandSender;
