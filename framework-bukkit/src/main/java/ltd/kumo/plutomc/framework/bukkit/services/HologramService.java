package ltd.kumo.plutomc.framework.bukkit.services;

import com.google.common.base.Preconditions;
import ltd.kumo.plutomc.framework.bukkit.holograms.holograms.Hologram;
import ltd.kumo.plutomc.framework.bukkit.holograms.holograms.HologramLine;
 ...
 * @since 2.0.12
 */
public final class HologramService implements Service<HologramService> {
     ...
     */
    public Hologram createHologram(String name, Location location) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException If name or location is null or hologram with the given name already exists.
     */
    public Hologram createHologram(String name, Location location, List<String> lines) throws IllegalArgumentException {
     ...
     */
    public void moveHologram(String name, Location location) throws IllegalArgumentException {
        Preconditions.checkNotNull(name);
        Preconditions.checkNotNull(location);
     ...
     * @throws IllegalArgumentException If hologram or location is null.
     */
    public void moveHologram(Hologram hologram, Location location) throws IllegalArgumentException {
     ...
     */
    public HologramLine createHologramLine(HologramPage parent, String content) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException If any of the arguments is null.
     */
    public HologramLine createHologramLine(HologramPage parent, Location location, String content) throws IllegalArgumentException {
        Preconditions.checkNotNull(parent);
        Preconditions.checkNotNull(location);
        Preconditions.checkNotNull(content);
     ...
     */
    public HologramPage addHologramPage(Hologram hologram) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException If hologram is null.
     */
    public HologramPage addHologramPage(Hologram hologram, List<String> lines) throws IllegalArgumentException {
        Preconditions.checkNotNull(hologram);
     ...
     */
    public HologramPage insertHologramPage(Hologram hologram, int index) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException If hologram is null or the index is out of bounds.
     */
    public HologramPage insertHologramPage(Hologram hologram, int index, List<String> lines) throws IllegalArgumentException {
        Preconditions.checkNotNull(hologram);
     ...
     */
    @Nullable
    public Hologram getHologram(String name) throws IllegalArgumentException {
        Preconditions.checkNotNull(name);
     ...
     */
    @Nullable
    public HologramPage getHologramPage(Hologram hologram, int index) throws IllegalArgumentException {
        Preconditions.checkNotNull(hologram);
     ...
     */
    @Nullable
    public HologramLine getHologramLine(HologramPage page, int index) throws IllegalArgumentException {
     ...
     */
    public HologramLine addHologramLine(Hologram hologram, Material material) throws IllegalArgumentException {
     ...
     */
    public HologramLine addHologramLine(Hologram hologram, ItemStack item) throws IllegalArgumentException {
     ...
     */
    public HologramLine addHologramLine(Hologram hologram, String content) throws IllegalArgumentException {
     ...
     */
    public HologramLine addHologramLine(Hologram hologram, int pageIndex, String content) throws IllegalArgumentException {
        Preconditions.checkNotNull(hologram);
        Preconditions.checkNotNull(content);
     ...
     */
    public HologramLine addHologramLine(HologramPage page, Material material) throws IllegalArgumentException {
        Preconditions.checkNotNull(material);
     ...
     */
    public HologramLine addHologramLine(HologramPage page, ItemStack item) throws IllegalArgumentException {
        Preconditions.checkNotNull(item);
     ...
     */
    public HologramLine addHologramLine(HologramPage page, String content) throws IllegalArgumentException {
        HologramLine line = new HologramLine(page, page.getNextLineLocation(), content);
        page.addLine(line);
        return line;
    }
     ...
     */
    public HologramLine insertHologramLine(Hologram hologram, int lineIndex, Material material) throws IllegalArgumentException {
        Preconditions.checkNotNull(material);
     ...
     */
    public HologramLine insertHologramLine(Hologram hologram, int lineIndex, ItemStack item) throws IllegalArgumentException {
        Preconditions.checkNotNull(item);
     ...
     * @throws IllegalArgumentException If hologram or content is null or the indexes are invalid.
     */
    public HologramLine insertHologramLine(Hologram hologram, int lineIndex, String content) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException If hologram or material is null or the indexes are invalid.
     */
    public HologramLine insertHologramLine(Hologram hologram, int pageIndex, int lineIndex, Material material) throws IllegalArgumentException {
        Preconditions.checkNotNull(material);
     ...
     * @throws IllegalArgumentException If hologram or item is null or the indexes are invalid.
     */
    public HologramLine insertHologramLine(Hologram hologram, int pageIndex, int lineIndex, ItemStack item) throws IllegalArgumentException {
        Preconditions.checkNotNull(item);
     ...
     * @throws IllegalArgumentException If hologram or content is null or the indexes are invalid.
     */
    public HologramLine insertHologramLine(Hologram hologram, int pageIndex, int lineIndex, String content) throws IllegalArgumentException {
        Preconditions.checkNotNull(hologram);
        HologramPage page = hologram.getPage(pageIndex);
        if (page == null) {
            throw new IllegalArgumentException("Given page index is out of bounds for the hologram.");
     ...
     */
    public HologramLine insertHologramLine(HologramPage page, int index, Material material) throws IllegalArgumentException {
        Preconditions.checkNotNull(material);
     ...
     */
    public HologramLine insertHologramLine(HologramPage page, int index, ItemStack item) throws IllegalArgumentException {
        Preconditions.checkNotNull(item);
     ...
     */
    public HologramLine insertHologramLine(HologramPage page, int index, String content) throws IllegalArgumentException {
     ...
     */
    public void setHologramLine(HologramLine line, Material material) throws IllegalArgumentException {
        Preconditions.checkNotNull(material);
     ...
     * @throws IllegalArgumentException If any of the arguments are null
     */
    public void setHologramLine(HologramLine line, ItemStack item) throws IllegalArgumentException {
        Preconditions.checkNotNull(item);
     ...
     * @throws IllegalArgumentException If any of the arguments is null.
     */
    public void setHologramLine(HologramLine line, String content) throws IllegalArgumentException {
     ...
     */
    public void setHologramLine(HologramPage page, int lineIndex, Material material) throws IllegalArgumentException {
        Preconditions.checkNotNull(material);
     ...
     * @throws IllegalArgumentException If any of the arguments are null or the indexes are invalid.
     */
    public void setHologramLine(HologramPage page, int lineIndex, ItemStack item) throws IllegalArgumentException {
        Preconditions.checkNotNull(item);
     ...
     */
    public void setHologramLine(HologramPage page, int lineIndex, String content) throws IllegalArgumentException {
        Preconditions.checkNotNull(page);
        Preconditions.checkNotNull(content);
     ...
     * @throws IllegalArgumentException If any of the arguments is null or the indexes are invalid.
     */
    public void setHologramLine(Hologram hologram, int lineIndex, Material material) throws IllegalArgumentException {
        Preconditions.checkNotNull(material);
     ...
     * @throws IllegalArgumentException If any of the arguments is null or the indexes are invalid.
     */
    public void setHologramLine(Hologram hologram, int lineIndex, ItemStack item) throws IllegalArgumentException {
        Preconditions.checkNotNull(item);
     ...
     * @throws IllegalArgumentException If any of the arguments is null or the indexes are invalid.
     */
    public void setHologramLine(Hologram hologram, int lineIndex, String content) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException If any of the arguments is null or the indexes are invalid.
     */
    public void setHologramLine(Hologram hologram, int pageIndex, int lineIndex, Material material) throws IllegalArgumentException {
        Preconditions.checkNotNull(material);
     ...
     * @throws IllegalArgumentException If any of the arguments is null or the indexes are invalid.
     */
    public void setHologramLine(Hologram hologram, int pageIndex, int lineIndex, ItemStack item) throws IllegalArgumentException {
        Preconditions.checkNotNull(item);
     ...
     * @throws IllegalArgumentException If any of the arguments is null or the indexes are invalid.
     */
    public void setHologramLine(Hologram hologram, int pageIndex, int lineIndex, String content) throws IllegalArgumentException {
        Preconditions.checkNotNull(hologram);
        Preconditions.checkNotNull(content);
     ...
     */
    @Nullable
    public HologramLine removeHologramLine(Hologram hologram, int lineIndex) throws IllegalArgumentException {
     ...
     */
    @Nullable
    public HologramLine removeHologramLine(Hologram hologram, int pageIndex, int lineIndex) throws IllegalArgumentException {
        Preconditions.checkNotNull(hologram);
        HologramPage page = hologram.getPage(pageIndex);
        if (page == null) {
            throw new IllegalArgumentException("Given page index is out of bounds for the hologram.");
     ...
     * @throws IllegalArgumentException If hologram is null.
     */
    public void setHologramLines(Hologram hologram, List<String> lines) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException If hologram is null.
     */
    public void setHologramLines(Hologram hologram, int pageIndex, List<String> lines) throws IllegalArgumentException {
        Preconditions.checkNotNull(hologram);
        if (lines == null || lines.isEmpty()) {
            return;
        }
