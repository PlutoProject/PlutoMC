...
import club.plutomc.plutoproject.framework.bukkit.command.argument.ArgumentBukkitDouble;
import club.plutomc.plutoproject.framework.bukkit.command.argument.ArgumentBukkitFloat;
import club.plutomc.plutoproject.framework.bukkit.command.argument.ArgumentBukkitInteger;
import club.plutomc.plutoproject.framework.bukkit.command.argument.ArgumentBukkitLong;
import club.plutomc.plutoproject.framework.bukkit.command.executor.BukkitPlayerExecutor;
import club.plutomc.plutoproject.framework.bukkit.command.sender.BukkitBlockCommandSender;
import club.plutomc.plutoproject.framework.bukkit.command.sender.BukkitCommandSender;
import club.plutomc.plutoproject.framework.bukkit.command.sender.BukkitConsoleCommandSender;
...
import club.plutomc.plutoproject.framework.shared.command.executors.Executor;
